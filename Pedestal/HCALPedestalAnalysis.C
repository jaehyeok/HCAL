...
{ 
    ...
    // 1D plots 
    TH1D *h1[2][4][4]; // [2]: mean, width / [4]: HB,HE,HO,HF / [4]: capid
    TH1D *h1_capsum[2][4]; // [2]: mean, width / [4]: HB,HE,HO,HF
    ...
    { 
        ...
        {   
            ...
            TString SubDet="HB"; if(subdet==1) SubDet="HE"; 
                                 if(subdet==2) SubDet="HO"; if(subdet==3) SubDet="HF"; 
    ...
    // 2D plots
    TH2D *h2[2][4][4][4]; // [2]: mean, width / [4]: HB,HE,HO,HF / [4]: depth / [4]: capid
...
{ 
    ...
    //
    //HCALPedestalTableAnalysis("PedestalTable_results_272944.txt");
    
    //
    // Analysis: compare two tables 
    //
    HCALPedestalCompareAnalysis("compare_272944_244174.root"); 
